...
* Configurar `application.yml` com H2 ou PostgreSQL local.
* Executar a aplicação (Spring Boot).
* Acessar as telas Thymeleaf para cadastro/login, cartões e intents.
* Usar o gateway mock para simular autorizações, capturas e geração de QR/link.
